...
class RankerTester(unittest.TestCase):
    ...
    def test_return_highest_hand(self):
        ...
        cards_list = [f'A{H}', f'K{H}', f'Q{H}', f'J{H}', f'T{H}', f'9{S}', f'2{S}']
        self.assertTrue(rank.determine_highest_hand(cards_list), "Failed return_highest_hand - test 1.1")
        self.assertTrue(rank.best_hand == 'Royal Flush', "Failed return_highest_hand - test 1.2")

        # Test True: Straight flush in hand
        cards_list = [f'5{H}', f'4{H}', f'6{H}', f'7{H}', f'8{H}', f'9{S}', f'2{S}']
        self.assertTrue(rank.determine_highest_hand(cards_list), "Failed return_highest_hand - test 2.1")
        ...
        self.assertTrue(rank.determine_highest_hand(cards_list), "Failed return_highest_hand - test 3.1")
        ...
        self.assertTrue(rank.determine_highest_hand(cards_list), "Failed return_highest_hand - test 4.1")
        ...
        self.assertTrue(rank.determine_highest_hand(cards_list), "Failed return_highest_hand - test 5.1")
        ...
        self.assertTrue(rank.determine_highest_hand(cards_list), "Failed return_highest_hand - test 6.1")
        ...
        self.assertTrue(rank.determine_highest_hand(cards_list), "Failed return_highest_hand - test 7.1")
        ...
        self.assertFalse(rank.determine_highest_hand(cards_list), "Failed return_highest_hand - test 8.1")
